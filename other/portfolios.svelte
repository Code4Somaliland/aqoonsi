...
&lt;/article&gt;
        ...
        <section class="bg-apple">
          <span class="background-left-bottom" style="background-image:url('../assets/img/iphone-hand.png')"></span>
          <div class="wrap">
        ...
        <section class="bg-gradient-white">
          <span class="background-right" style="background-image:url('../assets/img/iphone.png')"></span>
          <div class="wrap">
            <div class="content-left">
        ...
        <section class="aligncenter">
          <div class="wrap size-50">
            <figure class="browser">
              <a href="#" title="Title"><img src="../assets/img/cover-apple.jpg" alt="Screenshot"></a>
            </figure>
            ...
            <ul class="flexblock blink border">
              ...
              <li>
                <a href="#" title="Block Link = .blink">
                  <!--div required = padding li or li>a-->
                  <div>
                    <img class="aligncenter" src="../assets/img/logos/google.svg" alt="Google"> Collaboration with the Acme team to design their mobile apps.
                  </div>
                </a>
              </li>
              <li>
                <a href="#" title="Block Link = .blink">
                  <!--div required = padding li or li>a-->
                  <div>
                    <img class="aligncenter blacklogo" src="../assets/img/logos/google.svg" alt="Google"> We worked closely with the UX team on photography for the site. <code>img.blacklogo</code>
                  </div>
                </a>
              </li>
              <li>
                <a href="#" title="Block Link = .blink">
                  <!--div required = padding li or li>a-->
                  <div>
                    <img class="aligncenter graylogo" src="../assets/img/logos/google.svg" alt="Google"> Acme hired us to help make the reading experience totally engaging. <code>img.graylogo</code>
                  </div>
                </a>
              </li>
              <li class="bg-blue">
                <a href="#" title="Block Link = .blink">
                  <!--div required = padding li or li>a-->
                  <div>
                    <img class="aligncenter whitelogo" src="../assets/img/logos/google.svg" alt="Google"> We worked with Acme to develop recruiting processes. <code>img.whitelogo</code>
                  </div>
                </a>
              </li>
            </ul>
            ...
            <ul class="flexblock gallery">
              <li>
                <a href="../demos/why-webslides.html" title="Why WebSlides?">
                  <figure>
                    <img alt="Thumbnail Why WebSlides?" src="../assets/img/demos-why.png">
                    <figcaption>
                      <h2>Why WebSlides?</h2>
                    </figcaption>
                  </figure>
              ...
              <li>
                <a href="../demos/landings.html" title="Landings">
                  <figure>
                    <img alt="Thumbnail Landings" src="../assets/img/demos-landings.png">
                    <figcaption>
                      <h2>Landings</h2>
                    </figcaption>
                  </figure>
              ...
              <li>
                <a href="../demos/portfolios.html" title="Portfolios">
                  <figure>
                    <img alt="Thumbnail Portfolios" src="../assets/img/demos-portfolios.png">
                    <figcaption>
                      <h2>Portfolios</h2>
                    </figcaption>
                  </figure>
              ...
              <li>
                <a href="../demos/keynote.html" title="Apple Keynote">
                  <figure>
                    <img alt="Thumbnail Apple Keynote" src="../assets/img/demos-apple.png">
                    <figcaption>
                      <h2>Apple Keynote</h2>
                    </figcaption>
                  </figure>
        ...
        <section>
          ...
          <div class="wrap size-50 aligncenter">
              ...
              <blockquote>
                ...
                <p><cite> <img class="avatar-40" src="../assets/img/avatar.jpg" alt="Avatar"> <a href="http://twitter.com/jlantunez/">@jlantunez</a></cite></p>
              </blockquote>
          </div>
          <!-- .end .wrap -->
        </section>
        ...
        <section>
          <span class="background-left-bottom" style="background-image:url('../assets/img/satya.png')"></span>
          <div class="wrap">
            <div class="content-right">
              <blockquote>
