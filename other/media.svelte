					...
					<div>
						...
						<ol>
							...
							<li>
								...
								<ol>
									<li>
										<a target="_blank" href="#slide=27">Autoplay, loop, mute, and no controls</a>
									</li>
...
&lt;/figure&gt;</pre>
	...
	<section class="bg-blue">
		<span
			class="background dark"
			style="background-image:url('https://source.unsplash.com/R1J6Z1cnJZc/1600x800)"
		/>
...
<strong>&lt;/section&gt;</strong>
	...
	<section class="fullscreen aligncenter">
		<div class="embed">
			<video autoplay loop poster="../assets/img/peggy.jpg">
		...
		<div class="wrap size-60">
			...
			<div class="embed">
				<iframe
					width="800"
					height="450"
					src="https://www.youtube.com/embed/3Q3eITC01Fg"
					allowfullscreen
				/>
			</div>
			<!-- .end .embed -->
...
<strong>&lt;/section&gt;</strong>
	...
	<section class="fullscreen">
		...
		<div class="embed">
			<iframe
				width="800"
				height="450"
				src="https://www.youtube.com/embed/xSMB7kBynZA?playsinline=1"
				allowfullscreen
			/>
		</div>
		<!-- .end .embed -->
	...
	<section class="frame">
		...
		<div class="wrap size-60 bg-white">
			...
			<p class="text-intro">
				Embed videos with <strong>loop, autoplay, and muted</strong> attributes. The video will automatically
				play when the slide is loaded.
			</p>
			<p>
				<strong>You should use a local or a remote server</strong> since the YouTube API doesn't seem
				to work nicely when using the file directly on the browser.
			</p>
		</div>
		<!-- .end .wrap -->
	</section>
...
&lt;/div&gt;</pre>
	...
	<section class="frame">
		<div class="wrap size-60 bg-white">
			...
			<p class="text-intro">
				Autoplay is generally disabled on all mobile devices to prevent bandwidth consumption. User
				must execute the play manually.
			</p>
		</div>
		<!-- .end .wrap -->
	</section>
...
<strong>&lt;/section&gt;</strong>
	...
	<section class="fullscreen">
		<!-- Fullscreen Video -->
		<div class="embed">
			<div data-youtube data-youtube-id="dmkwb2KfLW8" data-autoplay data-loop data-no-controls />
		</div>
		<!-- .end .embed -->
	</section>
	<section>
...
<strong>&lt;/section&gt;</strong>
	...
	<section class="bg-primary">
		<span
			class="background-bottom dark"
			style="background-image:url('https://source.unsplash.com/RkBTPqPEGDo/1600x800)"
		/>
		<div class="wrap aligncenter">
			<h3>
				<svg class="fa-map">
			...
			<div class="card-50 bg-white">
				...
				<div class="flex-content">
					...
					<p>
						...
						Heritage Sites: the Alcazar palace complex, the Cathedral and the General Archive of the
						Indies.
					</p>
				</div>
				<!-- end .flex-content-->
	...
	<section>
		<div class="wrap size-60">
			...
			<div class="embed">
				...
				<div class="atlas-chart" data-id="rJt91kGnx" data-width="640" data-height="449">
					<img
						alt="Chart"
						src="https://www.theatlas.com/i/atlas_rJt91kGnx.png"
						style="max-width: 100%;"
					/>
				</div>
		...
		<div class="wrap">
			...
			<p>
				<a
					...
					class="button ga-track"
					data-ga-text="Download WebSlides (last slide demos)"
					title="Download WebSlides"
				>
	...
	<section class="bg-primary aligncenter">
		<h2 class="text-emoji zoomIn">
			<strong><a href="https://webslides.tv" title="WebSlides">😎</a></strong>
		</h2>
