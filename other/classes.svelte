<article id="webslides">
	...
	<section>
		...
		<footer>
			<div class="wrap">
				<p>
					<span class="alignleft"> Footer: logo, credits... (.alignleft) </span>
	...
	<section>
		<div class="wrap">
			<img class="aligncenter size-40" src="../assets/img/iphone.png" alt="iPhone" />
	...
	<section>
		<div class="wrap">
			<div class="content-center">
				<h3>5/9 center</h3>
				<p>
					lentils on Fridays, and a pigeon or so extra on Sundays, made away with three-quarters of
					his income.
				</p>
	...
	<section>
		<div class="wrap">
			<div class="content-right">
				...
				<p>
					he rest of it went in a doublet of fine cloth and velvet breeches and shoes to match for
					holidays,
				</p>
		...
		<div class="wrap">
			...
			<div class="grid">
				<div class="column">
					<h6>Why WebSlides?</h6>
					<p>
						There're excellent presentation tools out there. WebSlides is about good karma and
				...
				<div class="column">
					<figure>
						<img class="aligncenter" src="../assets/img/setup.png" alt="WebSlides Files" />
					</figure>
				</div>
				<!-- end .column -->
				<div class="column">
		...
		<div class="wrap">
			...
			<div class="grid sm">
				<div class="column">
					<h3>.column 1</h3>
					<p>
						Stendhal syndrome is a psychosomatic disorder that causes rapid heartbeat, dizziness,
						fainting, confusion and even hallucinations when an individual is exposed to an
						experience of great personal significance, particularly viewing art.
					</p>
				</div>
				<div class="column">
					<h3>.column 2</h3>
					<p>
						The illness is named after the 19th-century French author Stendhal (pseudonym of
						Marie-Henri Beyle), who described his experience with the phenomenon during his 1817
						visit to Florence in his book Naples and Florence: A Journey from Milan to Reggio.
					</p>
					<p>
						When he visited the Basilica of Santa Croce, where Niccolò Machiavelli, Michelangelo and
						Galileo Galilei are buried, he saw Giotto's frescoes for the first time and was overcome
						with emotion.
					</p>
				</div>
			</div>
		...
		<div class="wrap">
			...
			<div class="grid ms">
				<div class="column">
					<h3>.column 1</h3>
					<p>
						Beauty is a characteristic of an animal, idea, object, person or place that provides a
						perceptual experience of pleasure or satisfaction. Beauty is studied as part of
						aesthetics, culture, social psychology and sociology.
					</p>
					<p>
						An "ideal beauty" is an entity which is admired, or possesses features widely attributed
						to beauty in a particular culture, for perfection.
					</p>
				</div>
				<div class="column">
					<h3>.column 2</h3>
					<p>
						The experience of "beauty" often involves an interpretation of some entity as being in
			...
			<div class="grid sms">
				...
				<div class="column">
					...
					<p>
						...
						environments; the art and science of organizing and labelling websites, intranets,
						online communities and software to support usability and findability; and an emerging
						community of practice focused on bringing principles of design and architecture to the
						digital landscape.
					</p>
				</div>
				<div class="column">
					<h3>.column 3</h3>
					<p>
						The difficulty in establishing a common definition for "information architecture" arises
						partly from the term's existence in multiple fields.
					</p>
				</div>
			</div>
			<!--end .grid -->
		...
		<div class="wrap">
			<div class="card-50 bg-white">
				<div class="flex-content">
					...
					<p class="text-intro">
						<a href="http://unsplash.com">Unsplash</a> is a really cool resource. It is a collection
						of Creative Commons Zero licensed photos that are really great.
					</p>
					<ul class="description">
						<li>
	...
	<section>
		<div class="wrap">
			<div class="card-50 bg-white">
				<figure>
					<iframe
						src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1241.8442158987712!2d-0.1268272!3d51.5005848!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487604c38c8cd1d9%3A0xb78f2474b9a45aa9!2sBig+Ben!5e0!3m2!1ses!2ses!4v1491497625579"
						width="800"
						height="600"
						allowfullscreen
					/>
				...
				<div class="flex-content">
					...
					<ul class="description">
						...
						<li>
							...
							<a href="http://www.visitlondon.com/">visitlondon.com</a>
						</li>
					</ul>
					<p>
						There are many reasons to visit London. London has a diverse range of people and
						cultures, and more than 300 languages are spoken in the region.
					</p>
				</div>
				<!-- end .flex-content-->
			</div>
	...
	<section class="fullscreen">
		<div class="card-50">
			...
			<div class="flex-content">
				...
				<p>
					In Greek thought, inspiration meant that the poet or artist would go into ecstasy or furor
					poeticus, the divine frenzy or poetic madness. The Muses are the inspirational goddesses
...
&lt;/video&gt;</pre>
	...
	<section class="bg-black">
		...
		<div class="wrap">
			<p><code>.background-video</code></p>
			<h2>
				<strong>WebSlides is the easiest way to make HTML presentations. Inspire and engage.</strong
				>
			</h2>
		</div>
		<!-- .end .wrap -->
...
&lt;/ul&gt;</pre>
	...
	<section>
		<div class="card-50">
			...
			<!-- end .flex-content-->
			<figure>
				<img class="aligncenter" src="../assets/img/android.png" alt="Pixel Phone" />
			</figure>
		</div>
		<!-- .end card-50 -->
	</section>
			...
			<div class="bg-white shadow">
				<ul class="flexblock reasons">
					<li>
						...
						<p>
							Designers and marketers can now focus on the content. Simply <a
								href="../demos"
								title="WebSlides Demos">choose a demo</a
							> and customize it in minutes. Be memorable!
						</p>
					</li>
					<li>
						<h2>Good karma. Just the essentials and using lovely CSS.</h2>
						<p>
							WebSlides is about telling the story, and sharing it in a beautiful way. Hypertext and
							clean code as narrative elements.
						</p>
					</li>
				</ul>
			</div>
			...
			<div class="cta">
				...
				<div class="benefit">
					<p class="text-subtitle">
						Roboto in <a
							target="_blank"
							href="https://www.google.com/fonts#QuickUsePlace:quickUse/Family:Roboto:400,700,700italic,400italic,300,300italic"
							>Google Fonts</a
						>.
					</p>
	...
	<section>
		<div class="wrap">
			...
			<div class="text-cols">
				<p>
					<strong>Why WebSlides?</strong> There are excellent presentation tools out there.
					WebSlides is about sharing content, essential features, and clean markup.
					<strong>Each parent &lt;section&gt;</strong> in the #webslides element is an individual slide.
				</p>
				<p>
					<strong>WebSlides help you build a culture of innovation and excellence</strong>. When
					you're really passionate about your job, you can change the world. How to manage a
					design-driven organization? Leadership through usefulness, openness, empathy, and good
					taste.
				</p>
			</div>
			<ul class="flexblock metrics">
	...
	<section>
		<div class="wrap">
			<div class="cta text-serif">
				...
				<div class="benefit">
					<p class="text-subtitle">
						Maitree in <a target="_blank" href="https://fonts.google.com/specimen/Maitree"
							>Google Fonts</a
						>.
					</p>
					<h3><strong>The quick brown fox jumps over the lazy dog</strong>.</h3>
	...
	<section>
		<div class="wrap size-50">
			...
			<p>
				Imagine that you are in Florence. If you suddenly start to feel that you literally cannot
				breathe, you may be experiencing Stendhal Syndrome.
			</p>
			...
			<p>
				The beauty of Italian art has a concentrated perfection and transcendent sensuality that is
