      <article id="webslides">
        ...
        <section class="bg-apple aligncenter">
          ...
          <div class="wrap">
            <h1><img class="whitelogo" src="../assets/img/logos/apple.svg" alt="Apple Logo"></h1>
          </div>
          <!-- .end .wrap -->
        </section>
        ...
        <section class="bg-apple">
          <div class="wrap">
            <div class="card-50">
              <figure><img class="aligncenter" src="../assets/img/iphone.png" alt="iPhone"></figure>
        ...
        <section class="bg-apple">
          <div class="wrap">
            <div class="card-50">
              ...
              <!-- end .flex-content-->
              <figure>
                <img class="aligncenter" src="../assets/img/iphone.png" alt="iPhone 6">
              </figure>
            </div>
          </div>
          <!-- .end .wrap -->
        ...
        <section class="bg-apple">
          <span class="background-right-bottom" style="background-image:url('../assets/img/iphone-hand.png')"></span>
          <!--.wrap = container (width: 90%) -->
          <div class="wrap">
            <div class="content-left">
        ...
        <section class="bg-apple">
          ...
          <div class="wrap">
            <blockquote class="text-quote">
              ...
              <p>
                <cite>
                  <!-- <img class="avatar-56" src="../assets/img/avatar.jpg" alt="Avatar"> --> Steve Jobs.
                </cite>
              </p>
            </blockquote>
          </div>
        ...
        <section class="bg-apple">
          <span class="background-right-bottom" style="background-image:url('../assets/img/tim-cook.png')"></span>
          <div class="wrap">
            <div class="content-left">
              <blockquote>
