<article id="webslides">
	...
	<section class="bg-purple aligncenter">
		<span
			...
			style="background-image:url('https://source.unsplash.com/C1HhAQrbykQ/')"
		/>
		...
		<div class="wrap">
			<div class="grid vertical-align">
				<div class="column">
					...
					<p>
						Code looks neat, pure. It uses <strong>intuitive markup</strong> with popular naming
						conventions. There's no need to overuse classes or nesting. Based on
						<a href="https://github.com/jennschiffer/SimpleSlides">SimpleSlides</a>, by
						<a href="http://jennmoney.biz">Jenn Schiffer</a>. <strong>Tutorials</strong>:
						<a href="../demos/components.html" title="WebSlides Components">Components</a>
						&middot; <a href="../demos/classes.html" title="WebSlides Classes">Classes</a>.
					</p>
				</div>
				<!-- .end .column -->
				<div class="column">
...
&lt;/article&gt;
	...
	<section class="aligncenter">
		...
		<div class="wrap size-50">
			...
			<p class="text-intro">
				<strong>WebSlides</strong> is an open source tool for telling stories.<br />
	...
	<section class="bg-secondary">
		...
		<div class="wrap size-50 frame">
			...
			<p class="text-symbols">* * *</p>
			<p>
				Stories have the power to change the world. WebSlides helps you write better content,
				faster. Your slides are there to support your story. Choose words wisely, create meaning
			...
			<div class="bg-white shadow">
				<ul class="flexblock reasons">
					<li>
						...
						<p>
							There're excellent presentation tools out there. WebSlides is about telling the story,
							and sharing it in a beautiful way. Hypertext and clean code as narrative elements.
						</p>
					</li>
					<li>
						<h2>Work better, faster.</h2>
						<p>
							Designers, marketers, and journalists can now focus on the content. Simply <a
								href="https://webslides.tv/demos"
								title="WebSlides Demos">choose a demo</a
	...
	<section>
		<div class="wrap size-50">
			...
			<p>
				Everyone loves a good story. WebSlides is about <strong>good karma</strong>. This is about
				telling the story, and sharing it in a beautiful way. How? Making HTML presentations easy.
				Hypertext, clean code, and beauty as narrative elements.
			</p>
			<p class="text-symbols">* * *</p>
			<p class="aligncenter">
				Best,<br />
		...
		<div class="wrap">
			<div class="cta-cover">
				...
				<p class="alignright">
					...
					<span class="try"
						><a href="https://webslides.tv/demos" title="WebSlides Demos">Demos</a> &middot;
	...
	<section>
		<div class="wrap">
			<div class="grid vertical-align">
				...
				<!-- end column-->
				<div class="column">
					<h2>Cari is your best friend</h2>
					<p class="text-intro">Your life will be more complete.</p>
					<p>
						Cari makes connections based on your relationships, uses humor, and is eager to learn
						more about your world and how to make your life easier to manage.
					</p>
					<p>
						<a href="#" class="badge-ios" title="iOS App">iOS app</a>
						<a href="#" class="badge-android" title="Android app">Android app</a>
	...
	<section class="aligncenter">
		...
		<span
			class="background"
			style="background-image:url('https://source.unsplash.com/wn7Vdl8_yXc/1600x800')"
		/>
		<div class="wrap">
	...
	<section class="bg-black aligncenter">
		...
		<span
			class="background"
			style="background-image:url('https://source.unsplash.com/Vti8XHv2XjU/')"
		/>
		<div class="wrap">
				...
				<p>
					<span class="alignleft">
						<a href="#" title="Instagram">
							<img class="whitelogo" src="../assets/img/logos/airbnb.svg" alt="Airbnb" />
						</a></span
					>
	...
	<section class="bg-gradient-v">
		...
		<div class="wrap size-60">
			...
			<h2>
				WebSlides is about <strong>telling the story</strong>, and sharing it in a beautiful way.
			</h2>
		</div>
		<!-- .end .wrap -->
	</section>
	<section>
		<span
			class="background"
			style="background-image:url('https://source.unsplash.com/YMOHw3F1Hdk/')"
		/>
		<div class="wrap">
			<div class="alignright size-50 bg-trans-dark">
				...
				<p>
					The Daenerys has facilities such as a 24-hour front desk, an elevator with access to all
					rooms, and a terrace with a garden where guests can enjoy breakfast during the summer.
				</p>
	...
	<section class="bg-black">
		<span
			class="background"
			style="background-image:url('https://source.unsplash.com/7waHOTcvcT4/')"
		/>
		<div class="wrap">
	...
	<section class="slide-top">
		<span
			class="background"
			style="background-image:url('https://source.unsplash.com/5gn2soeAc40/')"
		/>
		<div class="wrap">
	...
	<section class="bg-black slide-bottom">
		<span
			class="background"
			style="background-image:url('https://source.unsplash.com/Q1p7bh3SHj8/')"
		/>
		<div class="wrap">
	...
	<section class="bg-primary">
		<div class="wrap">
			...
			<div class="content-left">
				<p>
					WebSlides is the easiest HTML presentation framework. All content is for demo purposes
					only. All images are the copyright of their respective owners.
				</p>
			</div>
			<!-- end .content-left -->
			<ul class="flexblock">
			...
			<ul class="flexblock blink border">
				...
				<li class="bg-blue">
					<a href="#" title="Block Link = .blink">
						...
						<div>
							<img
								class="aligncenter whitelogo"
								src="../assets/img/logos/google.svg"
								alt="Google"
							/>
							We worked with Acme to develop recruiting processes. <code>img.whitelogo</code>
						</div>
					</a>
				</li>
			</ul>
	...
	<section>
		...
		<div class="wrap">
			<div class="grid">
				<div class="column">
					<h3 class="text-context">FAQs</h3>
					<p>
						WebSlides is an open source solution by <a href="https://twitter.com/jlantunez"
							>@jlantunez</a
						>. If you have additional questions,
						<a href="https://twitter.com/webslides" title="@WebSlides">get in touch!</a>
					</p>
				</div>
				<!-- end .column -->
				<div class="column">
					<h6>Why WebSlides?</h6>
					<p>
						There are excellent presentation tools out there. WebSlides is about good karma and
						sharing content. Hypertext, clean code, and beauty as narrative elements.
					</p>
					<p class="text-symbols">* * *</p>
					<h6>Is WebSlides a framework?</h6>
					<p>
						We're all tired of heavy CSS frameworks. WebSlides is a starting point that provides
						basic <a href="../demos/components.html" title="WebSlides Components"
							>structural components</a
						>
						and a scalable
						<a href="../demos/classes.html" title="WebSlides Classes">CSS architecture</a>.
					</p>
				</div>
				<!-- end .column -->
				<div class="column">
					...
					<p>
						WebSlides is a cute solution for making HTML presentations, landings, and portfolios. <a
							href="../demos/components.html#slide=15">Put content wherever you want</a
						>, add <a href="../demos/components.html#slide=98">background images</a>,
						<a href="../demos/components.html#slide=101">videos</a>...
					</p>
					<p class="text-symbols">* * *</p>
					<h6>How easy is WebSlides?</h6>
					<p>
						You can create your own presentation instantly. Just a basic knowledge of HTML and CSS
						is required. Simply choose a demo and customize it.
					</p>
				</div>
				<!-- end .column -->
			</div>
	...
	<section>
		<div class="wrap">
			...
			<div class="text-cols">
				<p>
					Everyone loves a good story. WebSlides is about sharing and <strong>good karma</strong>.
					This is about telling the story, and sharing it in a beautiful way. How? Making HTML
					presentations easy. Hypertext, clean code, and beauty as narrative elements.
				</p>
				<p>
					<strong>WebSlides help you build a culture of innovation and excellence</strong>. How to
					manage a design-driven organization? Leadership through usefulness, openness, empathy, and
					good taste. When you're really passionate about your job, you can change the world.
				</p>
			</div>
	...
	<section>
		<span class="background-right" style="background-image:url('../assets/img/iphone.png')" />
		<!--.wrap = container (width: 90%) -->
		<div class="wrap">
			<div class="content-left">
				<h2>iPhone 7</h2>
		...
		<div class="wrap">
			<div class="card-50 bg-white">
				...
				<div class="flex-content">
					...
					<p>
						5-pocket low-rise jeans in washed stretch denim with a button fly and slim legs. The
						jeans are made partly from recycled cotton.
					</p>
				</div>
				<!-- end .flex-content-->
			</div>
				...
				<div class="flex-content">
					...
					<ul class="description">
						...
						<li>
							...
							<a href="http://www.alhambra-patronato.es/"> alhambra-patronato.es</a>
						</li>
					</ul>
					<p>
						The palatial city consist of six palaces and two tower-palaces, of which only the
						Palaces of Comares and of the Lions have been preserved.
					</p>
				</div>
				<!-- end .flex-content-->
			</div>
	...
	<section class="fullscreen bg-white">
		<div class="card-50">
			...
			<div class="flex-content">
				...
				<p class="text-intro">
					Bonsai is a Japanese art form using trees grown in containers &mdash; .fullscreen >
					.card-50.
				</p>
				<p>
					Similar practices exist in other cultures, including the Chinese tradition of penjing from
					which the art originated, and the miniature living landscapes of Vietnamese hòn non bộ.
				</p>
				<p class="text-symbols">* * *</p>
			</div>
			<!-- end .flex-content-->
	...
	<section>
		<div class="wrap">
			...
			<div class="content-left">
				<p>
					<code>.flexblock.metrics</code> All content is for demo purposes only, to show an example of
					a live site. All images are the copyright of their respective owners.
				</p>
			</div>
			<!-- end .content-left -->
			<ul class="flexblock metrics">
	...
	<section class="bg-black-blue">
		...
		<div class="wrap">
			<blockquote class="text-quote">
				<p>
					I have always appreciated designers who dare to reinterpret fabrics and proportions, so I
					follow the Japanese and Belgian designers.
				</p>
	...
	<section class="bg-primary">
		...
		<div class="wrap">
			<div class="content-right">
				<blockquote>
					<p>
						"We will reinvent productivity to empower every person and every organization on the
						planet to do more and achieve more."
					</p>
	...
	<section class="bg-apple">
		<span
			class="background-left-bottom"
			style="background-image:url('../assets/img/tim-cook.png')"
		/>
		<div class="wrap">
			<div class="content-right">
				<blockquote>
					<p>
						"Some people see innovation as change, but we have never really seen it like that. It's
	...
	<section class="bg-apple">
		...
		<div class="wrap">
			<div class="content-right">
				...
				<p>
					Check out all the places where you can check out. If you already accept credit and debit
					cards, simply contact your payment provider to start accepting Apple Pay:
				</p>
	...
	<section>
		<div class="wrap">
			...
			<ul class="flexblock">
				...
				<li>
					<div>
						<img class="graylogo" src="../assets/img/logos/google.svg" alt="Google" />
...
&lt;/div&gt;</pre>
	...
	<section class="fullscreen">
		<!-- Fullscreen Video -->
		<div class="embed">
			<div data-youtube data-youtube-id="b4LrTkWq9jU" data-autoplay />
		</div>
		<!-- .end .embed -->
	</section>
