		...
		<div class="wrap">
			<div class="grid vertical-align">
				<div class="column">
					...
					<p>
						Code looks superb. It uses <strong
							>intuitive markup with popular naming conventions</strong
						>. There's no need to overuse classes or nesting. Just focus on your ideas.
						<strong
							>Based on <a href="https://github.com/jennschiffer/SimpleSlides">SimpleSlides</a>, by
							<a href="http://jennmoney.biz">Jenn Schiffer</a></strong
						> :)
					</p>
				</div>
				<!-- .end .column -->
...
&lt;/article&gt;
			...
			<hr />
			<p class="aligncenter">
				Vertical sliding? <code>&lt;article id="webslides" class="vertical"&gt;</code>
			</p>
		</div>
		<!-- .end .wrap -->
	</section>
	<section>
		<div class="wrap size-50">
			...
			<ul class="description">
				<li>
					<span class="text-label">Typography:</span> .text-landing, .text-subtitle, .text-data, .text-intro...
				</li>
				<li><span class="text-label">BG Colors:</span> .bg-primary, .bg-blue,.bg-apple...</li>
				<li>
					<span class="text-label">BG Images:</span> .background, .background-center-bottom...
				</li>
				...
				<li>
					<span class="text-label">Flex Blocks:</span> .flexblock.clients, .flexblock.gallery, .flexblock.metrics...
				</li>
			</ul>
		</div>
		<!-- .end .wrap -->
	...
	<section>
		<header>
			...
			<div class="wrap">
				<p class="logo">
					<a href="#" title="Logo">Logo</a> <span class="alignright">.alignright</span>
				</p>
			</div>
		</header>
		...
		<footer>
			<div class="wrap">
				<p>
					<span class="alignleft"> Footer </span>
				...
				<p>
					<span class="alignleft"
						><a href="https://google.com" title="Google"
							><img src="../assets/img/logos/google.svg" alt="Google" /></a
						></span
					>
					<span class="alignright">
						<a href="#" title="Twitter">
		...
		<div class="wrap">
			...
			<div class="grid">
				...
				<div class="column">
					<h3>.column 2</h3>
					<p>
						Incredibly versatile! Auto-fill and equal height. Flexbox is awesome. Just focus on your
						content. Have less. Do more.
					</p>
				</div>
				<div class="column">
					<h3>.column 3</h3>
	...
	<section>
		<div class="wrap">
			<div class="content-left">
				...
				<p>
					Your slides should be clear and well structured. What's the point of the story? Why is
					that relevant?
				</p>
	...
	<section>
		<div class="wrap">
			<div class="content-right">
				...
				<p>
					Your presentation should have the same elements as a good book. Action, failure, and
					success.
				</p>
	...
	<section class="slide-bottom">
		<div class="wrap">
			<div class="content-left">
				...
				<p>
					How to tell strategic stories? What Promised Land is the company conveying through its
					words and images.
				</p>
	...
	<section class="slide-bottom">
		<div class="wrap">
			<div class="content-center">
				...
				<p>
					What's the Promised Land? What change do you want to bring to the world? The Promised Land
					is the North Star.
				</p>
	...
	<section class="slide-bottom">
		<div class="wrap">
			<div class="content-right">
				...
				<p>
					Your origin story helps people decide whether or not to trust you. How was your life
					before the life-changing event?
				</p>
	...
	<section>
		<div class="wrap">
			<img class="alignright size-50" src="../assets/img/iphone.png" alt="iPhone" />
			<h2>img.size-50</h2>
			...
			<p>
				...
				at the Moscone Center in San Francisco. Apple sold 6.1 million first generation iPhone units
				over five quarters.
			</p>
	...
	<section>
		<div class="wrap">
			<img class="alignleft size-50" src="../assets/img/iphone.png" alt="iPhone" />
			<h2>img.size-50</h2>
	...
	<section>
		<div class="wrap">
			<img class="alignleft size-30" src="../assets/img/iphone.png" alt="iPhone" />
			<h2>img.size-30</h2>
				...
				<li>
					<h2>
						<svg class="fa-balance-scale">
							<use xlink:href="#fa-balance-scale" />
						</svg>
						.flexblock li 2
					</h2>
			...
			<ul class="flexblock blink border">
				...
				<li>
					<a href="#" title="Block Link = .blink">
						<!--div required = padding li or li>a-->
						<div>
							<img class="aligncenter" src="../assets/img/logos/google.svg" alt="Google" /> Collaboration
							with the Acme team to design their mobile apps.
						</div>
					</a>
				</li>
				<li>
					...
					<a href="#" title="Block Link = .blink">
						...
						<div>
							<img
								...
								alt="Google"
							/>
							We worked with Acme to develop recruiting processes. <code>img.graylogo</code>
						</div>
					</a>
				</li>
			</ul>
	...
	<section>
		<div class="wrap">
			...
			<ul class="flexblock border blink">
				...
				<li>
					<a href="#" title="Microsoft"><strong>Microsoft</strong> 2015.- Content Strategy</a>
				</li>
				<li>
					<a href="#" title="The New York Times"
						><strong>The New York Times</strong>2015.- Recruitment</a
					>
				</li>
		...
		<div class="wrap">
			...
			<ul class="flexblock clients">
				<li>
					<a href="#" title="Client">
						<figure>
							<img class="blacklogo" src="../assets/img/logos/google.svg" alt="Google" />
							<figcaption>
								<h3>Interfaces</h3>
								<p>
									Collaboration with the Acme team to design their mobile apps. <code
										>img.blacklogo</code
									>
								</p>
							</figcaption>
				...
				<li>
					<a href="#" title="Client">
						<figure>
							<img class="blacklogo" src="../assets/img/logos/microsoft.svg" alt="Microsoft" />
							<figcaption>
								<h3>Brand</h3>
								<p>
									We worked with the UX team on photography for the site <code>img.blacklogo</code>
								</p>
							</figcaption>
						</figure>
					</a>
				...
				<li>
					<a href="#" title="Client">
						<figure>
							<img class="blacklogo" src="../assets/img/logos/instagram.svg" alt="Instagram" />
							<figcaption>
								<h3>Recruiting</h3>
								<p>
									We worked with Acme to develop recruiting processes. <code>img.blacklogo</code>
								</p>
							</figcaption>
						</figure>
					</a>
				...
				<li>
					<a href="#" title="Client">
						<figure>
							<img class="blacklogo" src="../assets/img/logos/netflix.svg" alt="Netflix" />
							<figcaption>
								<h3>Content Strategy</h3>
								<p>
									We partnered with various Netflix divisions to create a campaign for House of
									Cards.
								</p>
							</figcaption>
						</figure>
						...
						<div>
							<h2>
								<svg class="fa-long-arrow-right">
									<use xlink:href="#fa-long-arrow-right" />
								</svg>
	...
	<section>
		<div class="wrap">
			<div class="card-50">
						...
						<li>
							<div>
								<svg class="fa-battery-full">
									<use xlink:href="#fa-battery-full" />
								</svg>
				...
				<!-- end .flex-content-->
				<figure>
					<img class="aligncenter" src="../assets/img/iphone.png" alt="iPhone" />
				</figure>
			</div>
			<!-- .end card-50 -->
		</div>
			...
			<ul class="flexblock activity">
				<li>
					<a href="#" title="UX Designer at ACME">
						<div>
							<p class="year">2016</p>
							<p class="title">UX Designer at ACME</p>
							<p class="summary">
								This is a job description for the UX Designer role at ACME. Be concise. Content like
								a tweet: 2-3 lines recommended.
							</p>
						</div>
					</a>
				</li>
				<li>
					<a href="#" title="14 world famous buildings to inspire you">
						<p class="year">2 mins ago</p>
						<p class="title">14 world famous buildings to inspire you</p>
						<p class="summary">
							From the Colosseum to the Chrysler building, get a dose of inspiration from 14 of the
				...
				<li>
					<a href="#" title="Co-Founder of GAMMA">
						<p class="year">2013</p>
						<p class="title">Co-Founder of GAMMA</p>
						<p class="summary">
							The culture within an organization is an essential part for success. This is a job
							description. Be concise. 2-3 lines recommended.
						</p>
					</a>
				</li>
			</ul>
					...
					<a href="../demos/landings.html" title="Landings">
						<figure>
							<img
								...
								src="../assets/img/demos-landings.png"
							/>
							<figcaption>
								<h2>Landings</h2>
							</figcaption>
					...
					<a href="../demos/portfolios.html" title="Portfolios">
						<figure>
							<img
								...
								src="../assets/img/demos-portfolios.png"
							/>
							<figcaption>
								<h2>Portfolios</h2>
							</figcaption>
					...
					<a href="../demos/keynote.html" title="Apple Keynote">
						<figure>
							<img
								...
								src="../assets/img/demos-apple.png"
							/>
							<figcaption>
								<h2>Apple Keynote</h2>
							</figcaption>
	...
	<section class="aligncenter">
		<span
			class="background-right-top"
			style="background-image:url('../assets/img/balloon.png')"
		/>
		<div class="wrap">
			<p class="text-subtitle">
				Powered by <a
					href="https://twitter.com/search?f=tweets&vertical=default&q=%23WebSlides&src=typd"
					>#WebSlides</a
				>
			</p>
			<h1 class="text-landing">Landings</h1>
			<p class="text-intro">
				Create a simple web presence easily. <br /> Clean markup and lovely CSS.
			</p>
			<p>
	...
	<section class="bg-primary">
		<span
			...
			style="background-image:url('../assets/img/iphone-hand.png')"
		/>
		<div class="wrap">
			<div class="content-left">
				...
				<h2>
					<svg class="fa-apple">
						<use xlink:href="#fa-apple" />
					</svg>
					<strong>Call to action</strong>
				</h2>
				<p>
					Use your iPhone to pay securely and easily at over a million store locations and within
					apps — with a single touch.
				</p>
				<p>
				...
				<p class="alignright">
					...
					>
						<svg class="fa-cloud-download">
							<use xlink:href="#fa-cloud-download" />
						</svg>
						WebSlides
					</a>
					<span class="try"
						><a href="../demos/index.html" title="WebSlides Demos">Demos</a> &middot;
						<a href="https://github.com/webslides/webslides" title="Github">Github</a></span
					>
				</p>
			</div>
			<ul class="flexblock features">
	...
	<section class="aligncenter">
		...
		<div class="wrap">
			<div id="tab-3" class="tab-content current">
				...
				<p class="text-intro">
					<strong>Hi, this is WebSlides</strong>. HTML presentations made simple. <br />I'm a cute
					solution with clean markup and <strong>lovely CSS</strong>.
				</p>
			</div>
				...
				<p>
					<span class="alignleft">
						<a href="#" title="Instagram">
							<img class="whitelogo" src="../assets/img/logos/instagram.svg" alt="Instagram" />
						</a></span
					>
					<span class="alignright">
						<a href="#" class="badge-ios" title="iOS App">iOS app</a>
	...
	<section class="bg-black aligncenter">
		...
		<span
			class="background"
			style="background-image:url('https://source.unsplash.com/mGYxAWITqMg/')"
		/>
		<div class="wrap">
	...
	<section class="bg-black aligncenter">
		<span
			class="background"
			style="background-image:url('https://source.unsplash.com/-g4dgdOExsw/')"
		/>
		<div class="wrap">
	...
	<section class="bg-gradient-v">
		<span
			class="background dark"
			style="background-image:url('https://source.unsplash.com/nxfuA21kNHY/1440x1440')"
		/>
	...
	<section class="bg-black slide-top">
		<span
			class="background"
			style="background-image:url('https://source.unsplash.com/sK1hW5knKkw/')"
		/>
		<div class="wrap">
	...
	<section class="bg-black slide-top">
		<span
			class="background"
			style="background-image:url('https://source.unsplash.com/Q14J2k8VE3U/')"
		/>
		<div class="wrap">
	...
	<section class="bg-black aligncenter">
		<span
			...
			style="background-image:url('https://source.unsplash.com/rCOWMC8qf8A/')"
		/>
		<div class="wrap">
	...
	<section class="bg-black slide-bottom">
		<span
			class="background"
			style="background-image:url('https://source.unsplash.com/RSOxw9X-suY/')"
		/>
		<div class="wrap">
			<div class="content-left">
				<p>
					<svg class="large fa-tree">
						<use xlink:href="#fa-tree" />
					</svg>
				</p>
				<h2>1,000,000</h2>
	...
	<section>
		<div class="wrap">
			...
			<div class="content-left">
				<p>
					All content is for demo purposes only, to show an example of a live site. The easiest way
					to make HTML presentations. Inspire and engage.
				</p>
			</div>
			<!-- end .content-left -->
	...
	<section>
		...
		<div class="wrap">
			...
			<div class="content-left">
				<p>
					There are great presentation tools out there. This is about <strong>good karma</strong>:
					hypertext, clean code, and <strong>beauty</strong> as narrative elements. Three essential features.
				</p>
			</div>
			<ul class="flexblock features">
				<li>
	...
	<section class="bg-primary">
		<div class="wrap">
			...
			<div class="content-left">
				<p>
					All content is for demo purposes only, to show an example of a live site. All images are
			...
			<ul class="flexblock">
				<li>
					<div>
						<img class="whitelogo" src="../assets/img/logos/google.svg" alt="Google" />
					</div>
				</li>
				<li>
					<div>
						<img class="whitelogo" src="../assets/img/logos/microsoft.svg" alt="Microsoft" />
					</div>
				</li>
				<li>
					<div>
						<img class="whitelogo" src="../assets/img/logos/thetimes.svg" alt="The Times" />
					</div>
				</li>
			</ul>
		</div>
		...
		<div class="wrap size-50">
			...
			<div class="toc">
				<ol>
					...
					<li>
						<a href="#" title="Go to What is Design?"
	...
	<section>
		...
		<div class="wrap">
			<div class="content-left">
				<h2>iPhone 7</h2>
				<p>
					A phone should be absolutely simple, beautiful, and magical to use. 3D Touch, 12MP photos,
					and 4K video.
				</p>
				<div class="content-left">
					<h3>Benefit 1</h3>
				...
				<div class="content-left">
					<h3>Benefit 2</h3>
					<p>
						The art of storytelling. Inspire teams, fascinate customers, and gain attention from
						investors.
					</p>
				</div>
				<!-- .end .content-left -->
		...
		<div class="wrap">
			<div class="grid vertical-align">
				...
				<div class="column">
					...
					<p>
						Every iPhone they have made was built on the same belief. That a phone should be more
	...
	<section>
		<div class="wrap">
			<div class="grid vertical-align">
				<div class="column">
					<h1>
						<svg class="fa-android">
							<use xlink:href="#fa-android" />
						</svg>
						Pixel
					</h1>
					<p class="text-intro">
						The first phone with the Google Assistant built in. Centering vertically using
						grid.vertical-align.
					</p>
					<p>
						It has the highest rated smartphone camera. Ever. A battery that lasts all day. <strong
							>Unlimited storage for all your photos and videos</strong
				...
				<div class="column">
					<figure>
						<img src="../assets/img/android.png" alt="Pixel Phone" />
					</figure>
				</div>
				<!-- end figure-->
			</div>
			...
			<div class="card-50 bg-white">
				...
				<div class="flex-content">
					...
					<ul class="description">
						...
						<li>
							<strong class="text-label">Website:</strong>
							<a href="http://www.comune.fi.it/">comune.fi.it</a>
						</li>
					</ul>
					<p>
						Florence was a centre of medieval European trade and finance and one of the wealthiest
						cities of the time. It is considered the birthplace of the Renaissance, and has been
		...
		<div class="wrap">
			<div class="card-60 bg-white">
				...
				<div class="flex-content">
					...
					<p>
						<strong>Stendhal syndrome</strong> is a disorder that causes rapid heartbeat and dizziness
						when an individual is exposed to an experience of great personal significance, particularly
						viewing art.
					</p>
					<p>
						The illness is named after the 19th-century French author Stendhal, who described his
						experience with the phenomenon during his 1817 visit to Florence.
					</p>
				</div>
				<!-- end .flex-content-->
			</div>
	...
	<section class="fullscreen">
		<div class="card-50">
			...
			<div class="flex-content">
				...
				<p class="text-intro">
					Aqaba is the only coastal city in Jordan and the largest and most populous city on the
					Gulf of Aqaba.
				</p>
				<p class="aligncenter">
					<a class="button" href="https://en.wikipedia.org/wiki/Aqaba">Read more &raquo;</a>
				</p>
			</div>
			<!-- end .flex-content-->
		</div>
	...
	<section class="frame bg-red">
		<div class="wrap">
			<div class="cta">
				<div class="number">
					<img class="whitelogo" src="../assets/img/logos/netflix.svg" alt="Netflix" />
				</div>
				<!--end .number -->
				<div class="benefit">
	...
	<section class="frame bg-red">
		<span
			class="background dark"
			style="background-image:url('https://source.unsplash.com/R1J6Z1cnJZc/')"
		/>
		<div class="wrap">
			<div class="cta">
				<div class="number">
	...
	<section class="bg-black aligncenter">
		<span
			class="background light"
			style="background-image:url('https://source.unsplash.com/hHL08lF7Ikc/')"
		/>
		<div class="wrap">
	...
	<section>
		...
		<div class="wrap">
			...
			<div class="content-center">
				...
				<blockquote>
					<p>
						"I feel guilty as a web designer when I have to use PowerPoint and Keynote. So I made
						#WebSlides."
					</p>
					<p>
						<cite>
							<img class="avatar-40" src="../assets/img/avatar.jpg" alt="Avatar" />
							<a href="http://twitter.com/jlantunez/">@jlantunez</a></cite
						>
					</p>
				</blockquote>
			</div>
	...
	<section class="bg-black-blue">
		...
		<div class="wrap">
			<blockquote class="text-quote">
				<p>
					Leadership is not bullying and leadership is not aggression. Leadership is the expectation
					that you can use your voice for good.
				</p>
				<p>
					<cite
						><a href="https://en.wikipedia.org/wiki/Sheryl_Sandberg">Sheryl Sandberg</a>, COO of
						Facebook.</cite
					>
				</p>
			</blockquote>
	...
	<section class="bg-primary">
		...
		<footer>
			<div class="wrap">
				<p>
					<span class="alignleft"
						><img class="whitelogo" src="../assets/img/logos/google.svg" alt="Google" /></span
					>
		...
		<div class="wrap">
			<div class="card-50">
				...
				>
					...
					<figure><img src="../assets/img/davinci.png" alt="Leonardo da Vinci" /></figure>
				</a>
			</div>
		</div>
		<!-- .end .wrap -->
	...
	<section class="bg-primary">
		<span
			...
			style="background-image:url('../assets/img/satya.png')"
		/>
		<div class="wrap">
			<div class="content-right">
				<blockquote>
	...
	<section>
		<div class="wrap">
			<div class="content-left">
				...
				<p>
					<a href="#" class="button radius" title="Button"> .button.radius</a>
					<a href="#" class="button ghost" title="Button"> .button.ghost</a>
				</p>
			</div>
			<div class="content-left">
				<h2>Badges</h2>
				...
				<p>
					<a href="#" class="badge-ios" title="Download iOS App"> iOS App</a>
					<a href="#" class="badge-android" title="Download Android App"> Android App</a>
				</p>
			</div>
		</div>
		<!-- .end .wrap -->
	...
	<section class="bg-black aligncenter">
		<span
			class="background dark"
			style="background-image:url('https://source.unsplash.com/CxYHfBkC0vs/')"
		/>
		<div class="wrap">
	...
	<section class="bg-black">
		<span
			class="background"
			style="background-image:url('https://source.unsplash.com/p3UCTiZIU6M/')"
		/>
		<!--.wrap = container (width: 90%) -->
		<div class="wrap size-70 aligncenter">
			...
			<form action="/" method="post" class="bg-trans-dark">
				<ul class="flexblock">
					<li>
						<input type="email" tabindex="1" name="email" placeholder="your@email.com" required />
					</li>
					<li>
						<input type="password" tabindex="2" name="password" placeholder="Password" required />
					</li>
					<li>
						<button type="submit" class="radius" tabindex="3" title="Sign Up"
							>Sign Up &rsaquo;</button
						>
					</li>
				</ul>
			</form>
	...
	<section class="bg-apple">
		...
		<div class="wrap">
			<div class="content-left">
				...
				<p>
					Use your iPhone to pay securely and easily at over a million store locations and within
					apps — with a single touch. See where you can use Apple Pay:
				</p>
				<form action="/" class="user" method="post">
					<input
						...
						name="location"
						tabindex="1"
						placeholder="Stores in your city..."
						required
					/>
	...
	<section class="bg-primary">
		<span
			class="background dark"
			style="background-image:url('https://source.unsplash.com/RkBTPqPEGDo/')"
		/>
		<!--.wrap = container (width: 90%) -->
		<div class="wrap size-30">
			...
			<form action="/" method="post">
				<fieldset>
					...
					<p>
						<label
							>Password <span class="alignright"
								><a href="#" title="Forgot password?">Forgot?</a></span
							></label
						>
						<input
							type="password"
	...
	<section class="bg-black aligncenter">
		<span
			class="background dark"
			style="background-image:url('https://source.unsplash.com/Zq_K89I9E-8/)"
		/>
		<div class="wrap">
	...
	<section>
		...
		<div class="wrap size-50">
			...
			<p class="text-intro">
				<a href="https://source.unsplash.com/">How to embed Unsplash photos? &rarr;</a>
			</p>
			<pre>&lt;section&gt;
...
&lt;/section&gt;</pre>
	...
	<section class="bg-black aligncenter">
		<span
			class="background light"
			style="background-image:url('https://source.unsplash.com/1_CMoFsPfso/')"
		/>
		<div class="wrap size-50">
...
&lt;/section&gt;</pre>
	...
	<section class="aligncenter bg-black">
		<span
			...
			style="background-image:url('https://source.unsplash.com/n9WPPWiPPJw/')"
		/>
		<!--.wrap = container (width: 90%) -->
		<div class="wrap">
...
<strong>&lt;/section&gt;</strong>
	...
	<section class="fullscreen bg-blue aligncenter">
		<div class="embed dark">
			<video autoplay loop muted poster="../assets/img/peggy.jpg">
	...
	<section class="bg-black aligncenter">
		<span
			class="background dark"
			style="background-image:url('https://source.unsplash.com/MDGpwpMY2Ws/')"
		/>
		<!-- background with a frame frame -->
		<span class="background frame" />
		<div class="wrap">
...
&lt;/div&gt;</pre>
			...
			<div class="content-left">
				...
				<div class="embed">
					<iframe src="https://www.youtube.com/embed/XjJQBjWYDTs" allowfullscreen />
				</div>
				<!-- end .embed -->
			</div>
			<!-- end .content-left -->
	...
	<section>
		<div class="wrap size-60">
			...
			<div class="embed">
				<div data-youtube data-youtube-id="vXeF6Uot8pk" data-autoplay />
			</div>
			<!-- .end .embed -->
		</div>
		<!-- .end .wrap -->
	...
	<section>
		<div class="wrap size-60">
			...
			<div class="embed">
				...
				<div class="atlas-chart" data-id="H1tz4P9G" data-width="640" data-height="449">
					<img
						alt="Chart"
						src="https://www.theatlas.com/i/atlas_H1tz4P9G.png"
						style="max-width: 100%;"
					/>
				</div>
		...
		<div class="wrap size-50">
			...
			<div class="embed">
				<iframe
					width="800"
					height="450"
					src="https://dejiaccessnow.carto.com/viz/4f239c60-356f-11e5-b01c-0e853d047bba/embed_map"
					allowfullscreen
				/>
			</div>
			<!-- .end .embed -->
	...
	<section>
		<div class="wrap">
			<div class="card-50 bg-white">
				<figure>
					<iframe
						src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3170.254536199183!2d-5.994303837186783!3d37.38381233311839!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xbaa976bfaec1fe87!2sReal+Alc%C3%A1zar+de+Sevilla!5e0!3m2!1ses!2ses!4v1489408674667"
						width="800"
						height="600"
						allowfullscreen
					/>
				...
				<div class="flex-content">
					...
					<ul class="description">
						...
						<li>
							<strong class="text-label" title="Website">Website:</strong>
							<a href="http://www.visitasevilla.es/en">visitasevilla.es</a>
						</li>
					</ul>
					<p>
						There are many reasons to visit Seville. Its Old Town contains three UNESCO World
						Heritage Sites: the Alcázar palace complex, the Cathedral and the General Archive of the
						Indies.
					</p>
				</div>
				<!-- end .flex-content-->
...
&lt;/svg&gt;</pre>
	...
	<section>
		<div class="wrap">
			...
			<p>
				Change the color of a .svg/.png image using CSS. Images are property of their respective
				owners.
			</p>
			<hr />
			<ul class="flexblock blink">
				...
				<li>
					<a href="#" title="Block Link = .blink">
						<div>
							<img class="blacklogo" src="../assets/img/logos/airbnb.svg" alt="Airbnb" />
				...
				<li>
					<a href="#" title="Block Link = .blink">
						<div>
							<img class="graylogo" src="../assets/img/logos/microsoft.svg" alt="Microsoft" />
	...
	<section>
		...
		<div class="wrap">
			<blockquote class="text-quote">
				<p>
					"An avatar is the graphical representation of the user or the user's alter ego or
					character. The <a href="https://en.wikipedia.org/wiki/Avatar_(computing)">word avatar</a> originates
					in Hinduism."
				</p>
				<p>
					<cite>
						<a href="http://twitter.com/username/"
							><img class="avatar-56" src="../assets/img/avatar.jpg" alt="Avatar" /> @username</a
						>, .avatar-56</cite
					>
				</p>
			</blockquote>
		...
		<div class="wrap">
			<div class="content-left">
				<figure class="browser">
					<img alt="Screenshot" src="../assets/img/cover-apple.jpg" />
				</figure>
			</div>
			<!-- .end .content-left -->
			<div class="content-left">
...
&lt;/section&gt;</pre>
	...
	<section class="aligncenter">
		...
		<div class="wrap">
			...
			<p class="text-intro">
				Create your own presentation instantly. <br />120+ prebuilt slides ready to use.
			</p>
			<p>
				<a
					href="https://webslides.tv/webslides-latest.zip"
